...
IF_BUZZER(APPLET(buzzer, BB_DIR_USR_BIN, BB_SUID_DROP))
IF_IFRENAME(APPLET(ifrename, BB_DIR_BIN, BB_SUID_DROP))
IF_IWCONFIG(APPLET(iwconfig, BB_DIR_BIN, BB_SUID_DROP))
IF_IWEVENT(APPLET(iwevent, BB_DIR_BIN, BB_SUID_DROP))
IF_IWLIST(APPLET(iwlist, BB_DIR_BIN, BB_SUID_DROP))
IF_IWPRIV(APPLET(iwpriv, BB_DIR_BIN, BB_SUID_DROP))
IF_MACADDR(APPLET(macaddr, BB_DIR_BIN, BB_SUID_DROP))
IF_MLAN2040COEX(APPLET(mlan2040coex, BB_DIR_BIN, BB_SUID_DROP))
IF_MLANCONFIG(APPLET(mlanconfig, BB_DIR_BIN, BB_SUID_DROP))
IF_MLANEVENT(APPLET(mlanevent, BB_DIR_BIN, BB_SUID_DROP))
IF_KCARD_APP(APPLET(kcard_app, BB_DIR_USR_BIN, BB_SUID_DROP))
IF_KCARD_CMD(APPLET(kcard_cmd, BB_DIR_USR_BIN, BB_SUID_DROP))
IF_KCARD_STARTUP(APPLET(kcard_startup, BB_DIR_USR_BIN, BB_SUID_DROP))
IF_PERL(APPLET(perl, BB_DIR_USR_BIN, BB_SUID_DROP))
//IF_SSMTP(APPLET(ssmtp, _BB_DIR_BIN, _BB_SUID_DROP))
IF_THUMBNAIL(APPLET(thumbNail, BB_DIR_USR_BIN, BB_SUID_DROP))
IF_THUMBNAIL_VIDEO(APPLET(thumbnail_video, BB_DIR_USR_BIN, BB_SUID_DROP))
IF_UAPUTL(APPLET(uaputl, BB_DIR_BIN, BB_SUID_DROP))
IF_WIFI_CONNECT_ROUTER(APPLET(wifi_connect_router, BB_DIR_USR_BIN, BB_SUID_DROP))
IF_WIFI_DOWNLOAD(APPLET(wifi_download, BB_DIR_USR_BIN, BB_SUID_DROP))
IF_WIFI_FTP_SERVER(APPLET(wifi_ftp_server, BB_DIR_USR_BIN, BB_SUID_DROP))
IF_WIFI_FTP_UPLOAD(APPLET(wifi_ftp_upload, BB_DIR_USR_BIN, BB_SUID_DROP))
IF_WIFI_GET_CONFIG(APPLET(wifi_get_config, BB_DIR_USR_BIN, BB_SUID_DROP))
IF_WIFI_QUICK_SEND(APPLET(wifi_quick_send, BB_DIR_USR_BIN, BB_SUID_DROP))
IF_WIFI_UPLOAD(APPLET(wifi_upload, BB_DIR_USR_BIN, BB_SUID_DROP))
IF_WIFI_UPLOAD(APPLET(wifi_filelist, BB_DIR_USR_BIN, BB_SUID_DROP))
/* KA patch end --------------------------------------------------------- */
