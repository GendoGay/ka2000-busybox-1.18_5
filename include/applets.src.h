...
//IF_HELLO_KA(APPLET(hello_ka, _BB_DIR_BIN, _BB_SUID_DROP))
...
IF_IWCONFIG(APPLET(boa, _BB_DIR_BIN, _BB_SUID_DROP))
IF_IWCONFIG(APPLET(boa_indexer, _BB_DIR_BIN, _BB_SUID_DROP))
...
IF_MACADDR(APPLET(macaddr, _BB_DIR_BIN, _BB_SUID_DROP))
IF_MLAN2040COEX(APPLET(mlan2040coex, _BB_DIR_BIN, _BB_SUID_DROP))
IF_MLANCONFIG(APPLET(mlanconfig, _BB_DIR_BIN, _BB_SUID_DROP))
IF_MLANEVENT(APPLET(mlanevent, _BB_DIR_BIN, _BB_SUID_DROP))
IF_UAPUTL(APPLET(uaputl, _BB_DIR_BIN, _BB_SUID_DROP))
//IF_SSMTP(APPLET(ssmtp, _BB_DIR_BIN, _BB_SUID_DROP))
...
IF_KCARD_APP(APPLET(kcard_app, _BB_DIR_USR_BIN, _BB_SUID_DROP))
IF_KCARD_CMD(APPLET(kcard_cmd, _BB_DIR_USR_BIN, _BB_SUID_DROP))
IF_KCARD_STARTUP(APPLET(kcard_startup, _BB_DIR_USR_BIN, _BB_SUID_DROP))
IF_WIFI_GET_CONFIG(APPLET(wifi_get_config, _BB_DIR_USR_BIN, _BB_SUID_DROP))
IF_WIFI_GET_CONFIG_REAL(APPLET(wifi_get_config_real, _BB_DIR_USR_BIN, _BB_SUID_DROP))
IF_BUZZER(APPLET(buzzer, _BB_DIR_USR_BIN, _BB_SUID_DROP))
IF_THUMBNAIL(APPLET(thumbNail, _BB_DIR_USR_BIN, _BB_SUID_DROP))
IF_THUMBNAIL_VIDEO(APPLET(thumbnail_video, _BB_DIR_USR_BIN, _BB_SUID_DROP))
IF_WIFI_QUICK_SEND(APPLET(wifi_quick_send, _BB_DIR_USR_BIN, _BB_SUID_DROP))
IF_WIFI_FTP_SERVER(APPLET(wifi_ftp_server, _BB_DIR_USR_BIN, _BB_SUID_DROP))
IF_WIFI_CONNECT_ROUTER(APPLET(wifi_connect_router, _BB_DIR_USR_BIN, _BB_SUID_DROP))
IF_WIFI_FTP_UPLOAD(APPLET(wifi_ftp_upload, _BB_DIR_USR_BIN, _BB_SUID_DROP))
//Kobby-20120116-Add for support web list
IF_WIFI_SET_CONFIG(APPLET(wifi_set_config, _BB_DIR_USR_BIN, _BB_SUID_DROP))
IF_WIFI_GET_APCONFIG(APPLET(wifi_get_apconfig, _BB_DIR_USR_BIN, _BB_SUID_DROP))
IF_TSLIST(APPLET(tslist, _BB_DIR_USR_BIN, _BB_SUID_DROP))
IF_TSCMD(APPLET(tscmd, _BB_DIR_USR_BIN, _BB_SUID_DROP))
IF_FS_INFO(APPLET(fs_info, _BB_DIR_USR_BIN, _BB_SUID_DROP))
IF_GEN_FILELIST(APPLET(gen_filelist, _BB_DIR_USR_BIN, _BB_SUID_DROP))
IF_INSTANT_SETUPD(APPLET(instant_setupd, _BB_DIR_USR_BIN, _BB_SUID_DROP))
IF_IU_PROGRESSD(APPLET(iu_progressd, _BB_DIR_USR_BIN, _BB_SUID_DROP))
IF_CMD_SERVER(APPLET(cmd_server, _BB_DIR_USR_BIN, _BB_SUID_DROP))
IF_INSTANT_UPLOAD(APPLET(instant_upload, _BB_DIR_USR_BIN, _BB_SUID_DROP))
IF_INSTANT_UPLOAD_CLEAN(APPLET(instant_upload_clean, _BB_DIR_USR_BIN, _BB_SUID_DROP))
IF_WIFI_DOWNLOAD(APPLET(wifi_download, _BB_DIR_USR_BIN, _BB_SUID_DROP))
IF_WIFI_UPLOAD(APPLET(wifi_upload, _BB_DIR_USR_BIN, _BB_SUID_DROP))
IF_WIFI_UPLOAD(APPLET(wifi_filelist, _BB_DIR_USR_BIN, _BB_SUID_DROP))
...
IF_PERL(APPLET(perl, _BB_DIR_USR_BIN, _BB_SUID_DROP))
...
IF_GET_AUTHFILE(APPLET(get_authfile, _BB_DIR_USR_BIN, _BB_SUID_DROP))
